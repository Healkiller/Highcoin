...
#if defined(NDEBUG)
# error "Hight cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Hight Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nHeight, int64_t nFees)
{
    ...
    if(nHeight < 2)
    {
        nSubsidy = 100000 * COIN; //premine for swap and pre-sale
    }
	
		else if(nHeight < 30000)
    {
        nSubsidy = 0 * COIN; //mining fee
    }
		else if(nHeight < 50000)
    {
        nSubsidy = 1 * COIN; // + mining fee
    }
	
		else if(nHeight < 100000)
    {
        nSubsidy = 0.5 * COIN; //+ mining fee
    }
	
	
		else if(nHeight < 200000)
    {
        nSubsidy = 0.25 * COIN; //+ mining fee
    }
	
		else if(nHeight < 300000)
    {
        nSubsidy = 0.175 * COIN; // + mining fee
    }
	
		else if(nHeight < 400000)
    {
        nSubsidy = 0.04 * COIN; // + mining fee
    }
	
		else if(nHeight < 500000)
    {
        nSubsidy = 0.02 * COIN; //+ mining fee
    }
	
		else if(nHeight < 1000000)
    {
        nSubsidy = 0.01 * COIN; // + mining fee
    }
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    int64_t nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8);
                         ...
                         {
                                 nSubsidy = nSubsidy * 4 ;  //400% Superblocks
