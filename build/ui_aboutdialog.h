...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About HighCoin", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>HighCoin</b> version", Q_NULLPTR));
...
"Copyright \302\251 2017 The HighCoin developers", Q_NULLPTR));
